...
INSERT INTO actividad VALUES (4,'Fútbol Masculino',50,'Entrenamiento competitivo','2025-01-01','2025-12-31',2,4),(5,'Yoga para Adultos',30,'Bienestar y estiramiento','2025-01-15','2025-12-31',2,2),(6,'Natación Inicial',25,'Escuela de natación para principiantes','2025-02-01','2025-12-31',2,3);
...
INSERT INTO alquiler_cancha VALUES (2,'2025-10-22','10:00','13:00',2,2);
...
INSERT INTO cancha VALUES (2,'Calle Falsa 123','Cancha actualizada',25,1),(3,'Calle Falsa 123','Cancha actualizada',25,1),(4,'Sector A','Cancha de césped sintético',50,1),(5,'Sector B','Gimnasio de usos múltiples',30,1),(6,'Sector C','Pileta olímpica techada',25,1);
...
INSERT INTO cuota VALUES (1,1,'2025-10-22','2025-11-22'),(2,1,'2025-10-22','2025-11-22');
...
CREATE TABLE horario (
  ...
  PRIMARY KEY (id),
  KEY horario_actividad_id_foreign_idx (id_actividad),
  CONSTRAINT horario_actividad_id_foreign FOREIGN KEY (id_actividad) REFERENCES actividad (id) ON UPDATE CASCADE
...
INSERT INTO horario VALUES (7,'Lunes','18:00:00','20:00:00',4),(8,'Miércoles','18:00:00','20:00:00',5),(9,'Martes','10:00:00','11:30:00',6);
...
INSERT INTO inscripcion VALUES (3,'2025-02-20',2,4),(6,'2025-11-04',4,5),(7,'2025-11-05',5,6),(8,'2025-11-06',2,4),(9,'2025-11-06',4,4);
...
INSERT INTO monto_cuota VALUES ('2025-10-22',1750,1);
...
INSERT INTO profesor VALUES (1,'Carlos Ruiz','1144556677','carlos.ruiz@club.com'),(2,'Ana Torres','1144667788','ana.torres@club.com'),(3,'Pedro López','1144332211','pedro.lopez@club.com');
...
INSERT INTO usuario VALUES (2,'regi','1199887766','regi@mail.com','03AC674216F3E15C761EE1A5E255F067953623C8B388B4459E13F978D7C846F4','socio',1,12345688,'1990-05-15'),(3,'anyi','1122334455','anyi@mail.com','03AC674216F3E15C761EE1A5E255F067953623C8B388B4459E13F978D7C846F4','administrador',1,12345778,'1990-05-15'),(4,'delfi','1122334455','delfi@mail.com','03AC674216F3E15C761EE1A5E255F067953623C8B388B4459E13F978D7C846F4','socio',1,12346678,'1990-05-15'),(5,'fran','1122334455','fran@mail.com','03AC674216F3E15C761EE1A5E255F067953623C8B388B4459E13F978D7C846F4','socio',1,12355678,'1990-05-15');
...
-- Dump completed on 2025-11-06 16:17:37